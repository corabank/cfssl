  ...
  function appWrapper(module) {
    ...
    return [
        ...
        m('.container', [
          ...
          m('.collapse.navbar-collapse', [
            ...
            m('ul.nav.navbar-nav.navbar-right', [
              ...
              m('li', m('a[href="https://github.com/corabank/cfssl"]', 'GitHub')),
            ])
          ])
        ])
      ]),
      ...
      m('footer.container', {
        ...
        m('p', [
          'Code licensed under ',
          m('a[href="https://github.com/corabank/cfssl/blob/master/LICENSE"]', 'BSD-2-Clause'),
          '.'
        ])
      ])
    ];
    ...
    view: function() {
      return appWrapper([
        m('h1.page-header', 'CFSSL: Cloudflare\'s PKI toolkit'), m('p', [
          ...
          ' or ',
          m('a[href="https://github.com/corabank/cfssl"]', 'contribute on GitHub'),
          '.'
        ])
      ]);
    }
